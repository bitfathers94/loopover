...
const STDIO_TOOL_DESCRIPTORS = [
  ...
  },
  {
    ...
    category: "utility",
    description: "Return the latest cached full Gittensor repo registry snapshot (the raw current state, not a diff) from the public LoopOver API. Read-only; takes no parameters.",
  },
  {
