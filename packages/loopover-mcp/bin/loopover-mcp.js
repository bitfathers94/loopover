...
const STDIO_TOOL_DESCRIPTORS = [
    ...
    },
    {
        ...
        category: "maintainer",
        description: "Return a repo's own persisted focus manifest plus its compiled policy from the private LoopOver API (the stored per-repo contribution manifest, not an ad-hoc string to validate). Maintainer/owner/operator-authenticated; read-only.",
    },
    {
