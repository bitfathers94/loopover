...
// Mirrors scripts/rees-coverage.mjs: control-plane's node:test suite imports the built dist/, so
// running c8 from the monorepo root with source-map remapping yields `control-plane/src/**` paths
// (not bare `dist/**`), and the test list is expanded in-process so Windows/npm quoting cannot drop
// the suite.
